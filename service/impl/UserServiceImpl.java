...
public class UserServiceImpl implements UserService
{
	...
	@Override
	public String loginUser(@ModelAttribute("userDto") UserDto userDto, BindingResult result, Model model, HttpSession session) {
	    if (null != userDto 
	            && (null != userDto.getUserName() && !userDto.getUserName().trim().isEmpty())
	            && (null != userDto.getUserName() && !userDto.getUserPassword().trim().isEmpty())) {
	        ...
	        if (null == userEntity || 
	            ...
	            !userEntity.getUserPassword().equals(userDto.getUserPassword())) {
